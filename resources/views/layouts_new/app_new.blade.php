...
<head>
  ...
  <title>R&T Recuritment Management</title>
...
@include('layouts_new.upbar')
@include('layouts_new.sidebar')
<!-- Main Content -->
...
<footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2024 <div class="bullet"></div> Design By <a href="https://yourhelpgroup.com/kartar/">kartar Infotech</a>
        </div>
  ...
  <script src="assets/bundles/jquery-validation/dist/jquery.validate.min.js"></script>
   <script src="https://cdn.tiny.cloud/1/az7wnc5sa5ejrk2k2cvkb7zqn9hp8oqt7vyq2f74xsumakks/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>

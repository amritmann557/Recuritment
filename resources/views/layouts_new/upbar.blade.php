      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-bs-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <?php if(Auth::user()->gender == 'Female'){?> <img alt="image" src="assets/img/user.png"
                class="user-img-radious-style"> <?php } ?> <?php if(Auth::user()->gender == 'Male'){?>
			  ...
			  <?php } ?> <span class="d-sm-none d-lg-inline-block"></span></a>
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Hello {{Auth::user()->name;}}</div>
              <a href="{{route('viewProfileDetails')}}" class="dropdown-item has-icon"> <i class="far
										fa-user"></i> Profile
